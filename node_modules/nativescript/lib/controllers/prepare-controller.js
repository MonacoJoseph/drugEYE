...
class PrepareController extends events_1.EventEmitter {
    constructor($platformController, $hooksService, $logger, $nodeModulesDependenciesBuilder, $platformsDataService, $pluginsService, $prepareNativePlatformService, $projectChangesService, $projectDataService, $webpackCompilerService, $watchIgnoreListService, $analyticsService) {
        super();
