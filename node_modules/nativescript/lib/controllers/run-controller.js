...
class RunController extends events_1.EventEmitter {
    ...
    refreshApplication(projectData, liveSyncResultInfo, filesChangeEventData, deviceDescriptor) {
        return __awaiter(this, void 0, void 0, function* () {
            const result = deviceDescriptor.debuggingEnabled ?
                ...
                yield this.refreshApplicationWithoutDebug(projectData, liveSyncResultInfo, filesChangeEventData, deviceDescriptor);
    ...
    refreshApplicationWithoutDebug(projectData, liveSyncResultInfo, filesChangeEventData, deviceDescriptor, settings) {
        return __awaiter(this, void 0, void 0, function* () {
                ...
                try {
                    ...
                    if (data.hasNativeChanges) {
                        ...
                        const watchAction = () => __awaiter(this, void 0, void 0, function* () {
                            let liveSyncResultInfo = yield platformLiveSyncService.liveSyncWatchAction(device, watchInfo);
                            ...
                            if (!liveSyncResultInfo.didRecover && isInHMRMode) {
                                ...
                                if (status === constants_1.HmrConstants.HMR_ERROR_STATUS) {
                                    ...
                                    liveSyncResultInfo = yield platformLiveSyncService.liveSyncWatchAction(device, watchInfo);
