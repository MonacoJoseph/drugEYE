...
class UpdateController extends update_controller_base_1.UpdateControllerBase {
    ...
    shouldUpdateDependency(dependency, targetVersion, projectData) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const maxSatisfyingTargetVersion = yield this.getMaxDependencyVersion(dependency, targetVersion);
            const maxSatisfyingProjectVersion = yield this.getMaxDependencyVersion(dependency, projectVersion);
    ...
    shouldUpdateRuntimeVersion(templateRuntimeVersion, frameworkPackageName, platform, projectData) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const maxTemplateRuntimeVersion = yield this.getMaxDependencyVersion(frameworkPackageName, templateRuntimeVersion);
