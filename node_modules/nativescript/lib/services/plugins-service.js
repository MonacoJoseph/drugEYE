...
class PluginsService {
    constructor($packageManager, $fs, $options, $logger, $errors, $filesHashService, $injector, $mobileHelper) {
    ...
    preparePluginNativeCode(pluginData, platform, projectData) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            pluginData.pluginPlatformsFolderPath = (_platform) => path.join(pluginData.fullPath, "platforms", _platform.toLowerCase());
