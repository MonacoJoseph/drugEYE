...
class AndroidLiveSyncService extends platform_livesync_service_base_1.PlatformLiveSyncServiceBase {
    ...
    liveSyncWatchAction(device, liveSyncInfo) {
        return __awaiter(this, void 0, void 0, function* () {
            let result = yield this.liveSyncWatchActionCore(device, liveSyncInfo);
            if (liveSyncInfo.useHotModuleReload && !result.didRefresh && liveSyncInfo.hmrData && liveSyncInfo.hmrData.hash) {
                ...
                result = yield this.liveSyncWatchActionCore(device, liveSyncInfo);
                result.didRecover = true;
            }
            return result;
        });
    }
    liveSyncWatchActionCore(device, liveSyncInfo) {
