    ...
    shouldRestart(projectData, liveSyncInfo) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (liveSyncInfo.isFullSync || liveSyncInfo.waitForDebugger) {
                ...
                const isRefreshConnectionSetup = this.canRefreshWithNotification(projectData, liveSyncInfo) || (!this.device.isOnlyWiFiConnected && (yield this.setupSocketIfNeeded(projectData)));
