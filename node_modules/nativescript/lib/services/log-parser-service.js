...
class LogParserService extends events_1.EventEmitter {
    constructor($deviceLogProvider, $errors, $previewSdkService) {
        super();
    ...
    startParsingLogCore() {
        ...
        this.$previewSdkService.on(constants_1.DEVICE_LOG_EVENT_NAME, this.processDeviceLogResponse.bind(this));
    }
