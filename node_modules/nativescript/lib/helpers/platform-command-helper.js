...
class PlatformCommandHelper {
    constructor($platformController, $fs, $errors, $logger, $mobileHelper, $packageInstallationManager, $pacoteService, $platformsDataService, $platformValidationService, $projectChangesService, $projectDataService) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (canUpdate) {
                ...
                if (!semver.gt(currentVersion, newVersion)) {
                    yield this.updatePlatformCore(platformData, { currentVersion, newVersion, canUpdate }, projectData);
                }
