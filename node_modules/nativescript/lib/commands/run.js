...
class RunCommandBase {
    constructor($analyticsService, $androidBundleValidatorHelper, $devicePlatformsConstants, $errors, $hostInfo, $liveSyncCommandHelper, $migrateController, $options, $projectData) {
...
class RunIosCommand {
    ...
    canExecute(args) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const result = (yield this.runCommand.canExecute(args)) && (yield this.$platformValidationService.validateOptions(this.$options.provision, this.$options.teamId, projectData, this.$devicePlatformsConstants.iOS.toLowerCase()));
            return result;
        });
    }
}
