...
class PreviewCommand {
    constructor($analyticsService, $errors, $logger, $migrateController, $previewAppController, $networkConnectivityValidator, $projectData, $options, $previewAppLogProvider, $previewQrCodeService, $cleanupService) {
