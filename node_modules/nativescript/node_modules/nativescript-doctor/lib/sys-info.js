            ...
            try {
                ...
                if (javaHome) {
                    ...
                    if (this.fileSystem.exists(pathToJavaExecutable)) {
                        javaExecutableVersion = yield this.getVersionOfJavaExecutable(pathToJavaExecutable, regExp);
                    }
                }
            }
            catch (err) { }
    ...
    getVersionOfJavaExecutableFromPath(javaExecutableName, regExp) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                javaExecutableVersion = yield this.getVersionOfJavaExecutable(javaExecutableName, regExp);
            }
            catch (err) { }
            return javaExecutableVersion;
        });
